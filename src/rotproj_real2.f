...
c
c     User-callable f77 routine is rotviaproj2_real. 
c     User-callable f90 routine is rotviaproj2_realf90.
c     The other routines are used internally.
c
c***********************************************************************
      subroutine rotviaproj2_real
     1     (beta,alpha,nterms,m1,m2,mpole,lmp,marray2,lmpn,w,lw,lused)
c***********************************************************************
c       Purpose:
c
...
c        write(*,*) nquad
      ...
      if (lused.gt.lw) stop
c
      call rotviaproj20_real(beta,alpha,nquad,nterms,m1,m2,mpole,lmp,
...
c
c***********************************************************************
      subroutine rotviaproj20_real(beta,alpha,
     $     nquad,nterms,m1,m2,mpole,lmp,
...
c
      ...
      call evalall2a_real(beta,alpha,
     $   nquad,cthetas,sthetas,cphis,sphis,mpole,
...
C
C***********************************************************************
      subroutine evalall0a_real(beta,alpha,
     $     nquad,cthetas,sthetas,cphis,sphis,
...
C
C***********************************************************************
      subroutine evalall1a_real(beta,alpha,
     $     nquad,cthetas,sthetas,cphis,sphis,
     1     mpole,lmp,nterms,uval,uder,ynm,ynmd,ephis,rat1,rat2)
C***********************************************************************
C
...
C
C***********************************************************************
      subroutine evalall2a_real(beta,alpha,
     $     nquad,cthetas,sthetas,cphis,sphis,
     1     mpole,lmp,nterms,uval,uder,ynm,ynmd,ephis,rat1,rat2)
C***********************************************************************
C
...
C
c***********************************************************************
      subroutine rotviaproj2_realf90(beta,alpha,nterms,m1,m2,mpole,lmp,
     1           marray2,lmpn)
c***********************************************************************
c       Purpose:
c
...
c        write(*,*) nquad
      ...
      allocate (w(lused + 10000), stat=ier)
      iuval = 1
      iuder = iuval + nquad*(nterms+1)
      iephi = iuder + nquad*(nterms+1)
      ...
      ibvec = iavec + 2*nquad
      lused = ibvec + 2*nquad
      allocate (cw(lused + 10000), stat=ier)
      if (ier.ne.0) then 
         write(6,*) ' alloc failure in rotviaproj2_realf90'
         stop
      endif
c
      call rotviaproj20_real
     $          (beta,alpha,nquad,nterms,nterms,nterms,mpole,lmp,
     1           marray2,lmpn,w(ictheta),w(istheta),
     1           w(icphi),w(isphi),w(iynm),w(iynmd),
